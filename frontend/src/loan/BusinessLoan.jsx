  ...
  return (
    <div className="mt-20">
      ...
      <section className="text-white text-center py-16 px-6 ">
        <h1 className="text-4xl font-bold">Expand Your Business with a Business Loan</h1>
        <p className="mt-4 text-lg">Flexible funding solutions to help your business grow</p>
      ...
      <section className="max-w-6xl mx-auto py-12 px-6">
        <h2 className="text-3xl font-bold text-center">Why Choose Our Business Loan?</h2>
        <div className="grid md:grid-cols-3 gap-6 mt-8">
          {[ 
            { icon: <FaPercentage size={30} />, title: "Low Interest Rates", desc: "Starting from 5.0% per annum" },
            { icon: <FaRegClock size={30} />, title: "Flexible Tenure", desc: "Repay in 1-10 years" },
            { icon: <FaCheckCircle size={30} />, title: "Quick Approval", desc: "Minimal paperwork required" },
          ].map((item, index) => (
      ...
      <section className="py-12 px-6 bg-gray-800">
        ...
        <ul className="max-w-4xl mx-auto mt-6 space-y-4 text-lg text-white">
          ...
          <li className="flex items-center gap-2"><MdAttachMoney size={24} className="text-blue-600" /> Minimum annual revenue: $50,000</li>
          <li className="flex items-center gap-2"><MdWork size={24} className="text-blue-600" /> Business operational for at least 2 years</li>
